...
export function createReportArtifactJobPayload(overrides?: Partial<ReportArtifactJobPayload>): ReportArtifactJobPayload {
  const basePayload: ReportArtifactJobPayload = {
    jobId: 'f0f7f4df-2b17-4ea6-b95b-6096f8fd6670',
    requestedAt: new Date('2026-03-24T08:20:00.000Z'),
    ...
    source: {
      ...
      scoreResultSet: {
        ...
        scoredAt: new Date('2026-03-24T07:25:00.000Z'),
        createdAt: new Date('2026-03-24T07:25:00.000Z'),
      },
      scaleResults: [
        {
      ...
      patientProfile: {
        ...
        createdAt: new Date('2026-03-24T06:30:00.000Z'),
        updatedAt: new Date('2026-03-24T06:30:00.000Z'),
      },
      doctorProfile: {
